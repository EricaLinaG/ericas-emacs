...
;;; Commentary:
;; I grabbed this from the emacs wiki page about loading lisp files.
;; I realized, with auto-compile on, for load and save that everything
;; would always be up to date. That seems to be true.
;; found the doc on autocompile, says just that.- Eric
