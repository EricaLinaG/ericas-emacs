...
(add-to-list 'org-structure-template-alist '("a" . "src awk"))
(add-to-list 'org-structure-template-alist '("s" . "src sed"))
(add-to-list 'org-structure-template-alist '("la" . "src latex"))
(add-to-list 'org-structure-template-alist '("S" . "src scheme"))
(add-to-list 'org-structure-template-alist '("g" . "src gnuplot"))
